...
export default function PrivacyPage() {
    ...
    const UL = (props: { children: ReactNode }) => {
        return <ul className="ml-4">{props.children}</ul>
    }
    const dedent = 'lg:-ml-2 -ml-1'

    return (
        <div className="ml-10 mt-4 lg:ml-20">
            <h1 className="-ml-2 text-4xl">Privacy Policy</h1>
            ...
            <h1 className={`${dedent} text-2xl`}>Interpretation and Definitions</h1>
            <h2 className={`${dedent} text-xl`}>Interpretation</h2>
            <P>
                The words of which the initial letter is capitalized have meanings defined under the
                following conditions. The following definitions shall have the same meaning
                regardless of whether they appear in singular or in plural.
            </P>
            <h2 className={`${dedent} text-xl`}>Definitions</h2>
            ...
            <UL>
                ...
                <li>
                    <P>
                        <strong>Website</strong> refers to jack&apos;s site, accessible from{' '}
                        <a
                            href="https://jackschumann.com/"
                            rel="external nofollow noopener"
                            target="_blank"
                        >
                            https://jackschumann.com/
                        </a>
                    </P>
                </li>
                <li>
            ...
            <h2 className={`${dedent} text-xl`}>Types of Data Collected</h2>
            <h3 className={`${dedent} text-lg`}>Personal Data</h3>
            <P>
            ...
            <h3 className={`${dedent} text-lg`}>Usage Data</h3>
            ...
            <h3 className={`${dedent} text-lg`}>
                Information from Third-Party Social Media Services
            </h3>
            <P>
                The Company may allow You to create an account and log in to use the Service through
            ...
            <h3 className={`${dedent} text-lg`}>Tracking Technologies and Cookies</h3>
            <P>
            ...
            <h2 className={`${dedent} text-xl`}>Use of Your Personal Data</h2>
            ...
            <h2 className={`${dedent} text-xl`}>Retention of Your Personal Data</h2>
            <P>
            ...
            <h2 className={`${dedent} text-xl`}>Transfer of Your Personal Data</h2>
            <P>
            ...
            <h2 className={`${dedent} text-xl`}>Delete Your Personal Data</h2>
            <P>
                You have the right to delete or request that We assist in deleting the Personal Data
                that We have collected about You.
            </P>
            <P>
                You may submit a request for deletion via the email listed at the bottom of this
                page.
            </P>
            <P>
            ...
            <h2 className={`${dedent} text-xl`}>Disclosure of Your Personal Data</h2>
            ...
            <h2 className={`${dedent} text-xl`}>Security of Your Personal Data</h2>
            <P>
            ...
            <UL>
                <li>By email: contact.jack.schumann@gmail.com</li>
            </UL>
        </div>
    )
}
